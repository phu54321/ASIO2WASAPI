...
/* Purpose:
	...
	Returns:
	  ...
	  contain invalid _pref, ASE_InvalidMode will be returned.
	Notes:
...
/* Purpose:
	  ...
	  for _pDevice specific user _pref. This will not be
	...
	Notes:
	  if the user applied _pref which require a re-configuration
